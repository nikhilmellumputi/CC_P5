...
To check if all the pods are running - kubectl get all

**Open localhost:5000** for the Blog flask app

**Open localhost:5555** for the MongoDB Database



## Team Members :

**K Srujan** - PES2UG20CS172

**LN Sriranga** - PES2UG20CS179

**Md Arfaan Baig** - PES2UG20CS190

**Mellemputi Nikhil** - PES2UG20CS195