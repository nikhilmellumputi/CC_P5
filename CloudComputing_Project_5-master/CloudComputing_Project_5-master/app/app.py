...
user = 'KS_LNS_MAB_MN'           # username as set for the mongodb admin server (the username used in secret.yaml - before base64 conversion)
password = '172_179_190_195'       # password as set for the mongodb admin server (the password used in secret.yaml - before base64 conversion)
host = 'mongodb-admin-service'    # service name of the mongodb admin server as set in the service for mongodb server
